...
const Question = () => {
    ...
    return (
        <div className="mt-0 mb-20 md:mt-24 md:mb-10 px-5 md:px-20">
            ...
            <Accordion open={open === 1} icon={<Icon id={1} open={open} />}>
                <AccordionHeader onClick={() => handleOpen(1)}>What is the adoption process like?</AccordionHeader>
            ...
            <Accordion open={open === 2} icon={<Icon id={2} open={open} />}>
                <AccordionHeader onClick={() => handleOpen(2)}>What are the requirements to adopt a pet?</AccordionHeader>
                <AccordionBody className="text-md text-gray-600 dark:text-gray-400 lg:text-base font-medium">
            ...
            <Accordion open={open === 3} icon={<Icon id={3} open={open} />}>
                <AccordionHeader onClick={() => handleOpen(3)}>What support is available after adoption?</AccordionHeader>
                <AccordionBody className="text-md text-gray-600 dark:text-gray-400 lg:text-base font-medium">
            ...
            <Accordion open={open === 4} icon={<Icon id={4} open={open} />}>
                <AccordionHeader onClick={() => handleOpen(4)}>What should I consider before adopting a pet?</AccordionHeader>
                <AccordionBody className="text-md text-gray-600 dark:text-gray-400 lg:text-base font-medium">
            ...
            <Accordion open={open === 5} icon={<Icon id={5} open={open} />}>
                <AccordionHeader onClick={() => handleOpen(5)}>How can I prepare my home for a new pet?</AccordionHeader>
                <AccordionBody className="text-md text-gray-600 dark:text-gray-400 lg:text-base font-medium">
