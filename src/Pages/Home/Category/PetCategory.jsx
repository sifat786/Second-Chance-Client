    ...
    <div className="mt-10 md:mt-[70px] lg:my-[100px]">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 md:gap-6 lg:gap-8 space-y-4 md:space-y-0">
                ...
                <div className="w-full h-full bg-cover rounded-lg pt-[250px]" style={{backgroundImage: `url(${dog})`}}>
                  <h3 className='text-center py-1 text-lg font-medium bg-gradient-to-r from-teal-500 via-cyan-600 to-blue-700 text-white rounded-b-lg'>Dog</h3>
                </div>
                <div className="w-full h-full bg-cover rounded-lg pt-[250px]" style={{backgroundImage: `url(${cat})`}}>
                  <h3 className='text-center py-1 text-lg font-medium bg-gradient-to-r from-teal-500 via-cyan-600 to-blue-700 text-white rounded-b-lg'>Cat</h3>
                </div>
                <div className="w-full h-full bg-cover rounded-lg pt-[250px]" style={{backgroundImage: `url(${rabbit})`}}>
                  <h3 className='text-center py-1 text-lg font-medium bg-gradient-to-r from-teal-500 via-cyan-600 to-blue-700 text-white rounded-b-lg'>Rabbit</h3>
                </div>
                <div className="w-full h-full bg-cover rounded-lg pt-[250px]" style={{backgroundImage: `url(${fish})`}}>
                  <h3 className='text-center py-1 text-lg font-medium bg-gradient-to-r from-teal-500 via-cyan-600 to-blue-700 text-white rounded-b-lg'>Fish</h3>
                </div>
                <div className="w-full h-full bg-cover rounded-lg pt-[250px]" style={{backgroundImage: `url(${hamsters})`}}>
                  <h3 className='text-center py-1 text-lg font-medium bg-gradient-to-r from-teal-500 via-cyan-600 to-blue-700 text-white rounded-b-lg'>Hamsters</h3>
                </div>
                <div className="w-full h-full bg-cover rounded-lg pt-[250px]" style={{backgroundImage: `url(${bird})`}}>
                  <h3 className='text-center py-1 text-lg font-medium bg-gradient-to-r from-teal-500 via-cyan-600 to-blue-700 text-white rounded-b-lg'>Bird</h3>
                </div>
