            ...
            >
                <SwiperSlide>
                    <div className="py-16 md:py-[100px] lg:py-[160px] px-10 lg:px-0 bg-[linear-gradient(to_right_bottom,rgba(0,0,0,0.3),rgba(0,0,0,0.7)),url('https://i.ibb.co/7YsdxmD/b2.jpg')] bg-cover bg-center bg-no-repeat text-center rounded-lg">
                        ...
                        <p className="pt-4 w-auto md:w-[500px] lg:w-[600px] h-20 md:h-auto m-auto text-center text-sm md:text-base text-gray-200 font-medium">Discover the joy of pet adoption and bring home a loyal companion. Explore our diverse selection of pets ready to join your family.</p>
                        <a href="#faq">
                ...
                <SwiperSlide>
                    <div className="py-16 md:py-[100px] lg:py-[160px] px-10 lg:px-0 bg-[linear-gradient(to_right_bottom,rgba(0,0,0,0.3),rgba(0,0,0,0.7)),url('https://i.ibb.co/FqxdpXS/b3.jpg')] bg-cover bg-center bg-no-repeat text-center rounded-lg">
                        ...
                        <p className="pt-4 w-auto md:w-[500px] lg:w-[600px] h-20 md:h-auto m-auto text-center text-sm md:text-base text-gray-200 font-medium">Our mission is to connect loving families with pets in need. Browse our adoption listings and find a pet who needs your love and care. Adopt today!</p>
                        <a href="#faq">
                            <button className="bg-transparent border-2 border-white mt-8 py-2 px-4 md:py-[9px] md:px-11 text-white md:text-xl font-medium rounded-lg">Learn More</button>
                        </a>
                    </div>
                ...
                <SwiperSlide>
                    <div className="py-16 md:py-[100px] lg:py-[160px] px-10 lg:px-0 bg-[linear-gradient(to_right_bottom,rgba(0,0,0,0.3),rgba(0,0,0,0.7)),url('https://i.ibb.co/f1Jpkjq/b1.jpg')] bg-cover bg-center bg-no-repeat text-center rounded-lg">
                        ...
                        <p className="pt-4 w-auto md:w-[500px] lg:w-[600px] h-20 md:h-auto m-auto text-center text-sm md:text-base text-gray-200 font-medium">Every pet deserves a second chance at happiness. By adopting, you are saving a life and gaining a new family member. Explore our pets today.</p>
                        <a href="#faq">
                            <button className="bg-transparent border-2 border-white mt-8 py-2 px-4 md:py-[9px] md:px-11 text-white md:text-xl font-medium rounded-lg">Learn More</button>
                        </a>
                    </div>
                ...
                <SwiperSlide>
                    <div className="py-16 md:py-[100px] lg:py-[160px] px-10 lg:px-0 bg-[linear-gradient(to_right_bottom,rgba(0,0,0,0.3),rgba(0,0,0,0.7)),url('https://i.ibb.co/SxxnXq8/b4.jpg')] bg-cover bg-center bg-no-repeat text-center rounded-lg">
                        ...
                        <p className="pt-4 w-auto md:w-[500px] lg:w-[600px] h-20 md:h-auto m-auto text-center text-sm md:text-base text-gray-200 font-medium">Adding a pet to your family brings joy and companionship. Find the perfect pet to complete your family at Second Chance. Start your adoption journey now.</p>
                        <a href="#faq">
                            <button className="bg-transparent border-2 border-white mt-8 py-2 px-4 md:py-[9px] md:px-11 text-white md:text-xl font-medium rounded-lg">Learn More</button>
                        </a>
                    </div>
